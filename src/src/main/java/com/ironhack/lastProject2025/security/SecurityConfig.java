...
import com.ironhack.lastProject2025.security.filters.CustomAuthenticationFilter;
import com.ironhack.lastProject2025.security.filters.CustomAuthorizationFilter;
    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests((requests) -> requests
                        /*
                        .requestMatchers("/api/clubs/**").hasRole("APPUSER")
                        .requestMatchers("/api/clubs/**").hasRole("CLUBADMIN")
                        .requestMatchers("/api/memberships/**").hasRole("APPUSER")
                        .requestMatchers("/api/memberships/**").hasRole("USERMEMBER")
                         */
